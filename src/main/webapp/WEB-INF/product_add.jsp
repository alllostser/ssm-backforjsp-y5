...
<div id="app">
    ...
    <div class="main" id="app">
        ...
        <div class="right">
            ...
            <form class="layui-form " action="/manage/product/do_add.do">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="mainImage" id="pic_url" placeholder="不上传就留空" autocomplete="off"
                               class="layui-input">
                    </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="price" lay-verify="required|number" placeholder="输入正数" autocomplete="off" class="layui-input">
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" name="stock" lay-verify="required|number" placeholder="输入0以上的数" autocomplete="off" class="layui-input">
                    </div>
                </div>
